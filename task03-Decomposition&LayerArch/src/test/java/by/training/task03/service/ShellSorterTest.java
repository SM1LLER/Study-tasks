...
import by.training.task03.service.impl.ShellSorter;
...
public class ShellSorterTest {
    ...
    @Test(description = "Test with positive result for shell sort()", dataProvider = "positiveForSorterTest"
    ...
    @Test(description = "Test with big input for shell sort()", dataProvider = "bigInputSorterTest"
            , dataProviderClass = SorterTestData.class)
